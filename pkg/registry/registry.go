...
import (
		"github.com/X4Applegate/watchtower/pkg/registry/helpers"
		watchtowerTypes "github.com/X4Applegate/watchtower/pkg/types"
...
func GetPullOptions(imageName string) (types.ImagePullOptions, error) {
		log.Debugf("Getting pull options for image: %s", imageName)
